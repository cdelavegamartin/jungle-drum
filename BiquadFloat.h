// BiquadFloat.h: Header file for a Biquad class, almost identical to the one in
// the Bela library, but using floats. Probably there was a clever way to do it
// with templates.
#pragma once
